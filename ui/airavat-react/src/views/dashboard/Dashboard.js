    ...
    <>
      ...
      <CCard>
        <CCardBody>
          <CRow>
            <CCol sm="5">
              <h4 id="traffic" className="card-title mb-0">Server Load</h4>
              <div className="small text-muted">Past 24 hours</div>
            </CCol>
            <CCol sm="7" className="d-none d-md-block">
              ...
              <CDropdown className="float-right">
                <CDropdownToggle color="secondary">
                  Host : 10.11.21.21 <CIcon name="cil-settings"/>
                </CDropdownToggle>
                <CDropdownMenu className="pt-0">
                  <CDropdownItem>10.11.21.21</CDropdownItem>
                  <CDropdownItem>10.125.21.24</CDropdownItem>
                </CDropdownMenu>
            </CDropdown>
            </CCol>
          </CRow>
